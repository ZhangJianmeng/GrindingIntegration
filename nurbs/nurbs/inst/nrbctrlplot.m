...
% Plot the control points
    ...
    plot3 (coefs(1,:), coefs(2,:), coefs(3,:), 'r.','MarkerSize',8);
...
% And plot the control net
    for ii = 1:size (nurbs.coefs, 2)
      ...
      plot3 (coefs(1,:)./weights, coefs(2,:)./weights, coefs(3,:)./weights,'k--')
      plot3 (coefs(1,:)./weights, coefs(2,:)./weights, coefs(3,:)./weights,'r.','MarkerSize',8)
    end
    for jj = 1:size (nurbs.coefs, 3)
...
% And plot the control polygon
  ...
  plot3 (coefs(1,:)./weights, coefs(2,:)./weights, coefs(3,:)./weights,'k--')
  plot3 (coefs(1,:)./weights, coefs(2,:)./weights, coefs(3,:)./weights,'b.','MarkerSize',20)
end
